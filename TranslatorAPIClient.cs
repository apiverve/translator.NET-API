...
namespace APIVerve
{
    ...
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/translator";
        ...
        public TranslatorAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }
        ...
        public TranslatorAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, TranslatorQueryOptions options = null)
        {
        ...
        /// <param name="options"></param>
        /// <returns></returns>
        public ResponseObj Execute(TranslatorQueryOptions options = null)
        {
            try
            {
                if (_isDebug)
        ...
        private string constructURL(TranslatorQueryOptions options)
        {
